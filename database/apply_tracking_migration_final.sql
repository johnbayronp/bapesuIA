-- =====================================================
-- MIGRACIÓN FINAL PARA CAMPOS DE TRACKING
-- =====================================================
...
BEGIN 
    IF NOT EXISTS (
        ...
        END;
        $$ LANGUAGE plpgsql;
        RAISE NOTICE 'Función validate_shipping_tracking creada';
    ELSE
        RAISE NOTICE 'Función validate_shipping_tracking ya existe';
    END IF;
END $$;
